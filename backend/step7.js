...
async function main() {
    ...
    console.log("# Number of returned documents: ", pdfQA.retriever.k);
    ...
    const relevantDocuments = await pdfQA.retriever.invoke("What can you do with Symbolic Mode?");
    console.log("\n" + relevantDocuments);
    
// or we can also get :

//  console.log("\n" + relevantDocuments[0].pageContent);
//or

//  console.log("\n" + relevantDocuments[0].metadata);
